...
const hexadecimalNumber = getHexadecimalNumber(6); 
const bgColor = getBgColor(hexadecimalNumber);

function getHexadecimalNumber(size) { 
    let hexArray = [];
